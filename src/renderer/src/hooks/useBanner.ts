...
const CACHE_KEY = (slotId: string): string => `medialab.banner.${slotId}`
...
function writeCache(slotId: string, banner: Banner | null): void {
  try {
 ...
 */
export function useBanner(slotId: string): Banner | null {
